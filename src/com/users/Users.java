...
//======================   User Operation    ===========================================
	...
	public void userOperation() throws SQLException
	{
		...
		preparedStatement=connection.prepareStatement("insert into purchases(user_id,product_id,quantity,price_at_purchase)values(?,?,?,?)");
		...
		preparedStatement.executeUpdate();
		preparedStatement.close();
		System.out.println("Save purchase record immediately into the purchases. ");
